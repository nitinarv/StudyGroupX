package com.sgxp.asgmt1.quickaction;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public QuickAction(Context context) {
		...
		mTrackAnim = AnimationUtils.loadAnimation(context, R.anim.asgmt1_rail);
		...
		setRootViewId(R.layout.asgmt1_quick_action);
	...
	public void addActionItem(ActionItem action) {
		...
		View container = (View) inflater.inflate(R.layout.asgmt1_action_item, null);
	...
	public void show(View anchor) {
		...
		// showArrow(((onTop) ? R.id.arrow_down :
		// R.id.arrow_up),anchorRect.centerX());

		showArrow(((onTop) ? R.id.arrow_down : R.id.arrow_up), anchorRect.right);
